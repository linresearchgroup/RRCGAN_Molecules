...
try:
    encoder = load_model('./encoder_newencinp.h5')
    decoder = load_model('./decoder_newencinp.h5')
    model = load_model  ('./ae_model_newencinp.h5')
...
model.save  ('./ae_model_newenc.h5')
encoder.save('./encoder_newenc.h5')
decoder.save('./decoder_newenc.h5')
...
for i in [5, 10, 32, 88, 99]:
    ...
    plt.tight_layout()
    plt.savefig("smiles_{}_train.png".format(i), dpi=500) 
