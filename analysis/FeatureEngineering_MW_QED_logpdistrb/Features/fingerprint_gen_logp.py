...
csv_filename = 'Regular_NODUP_60ksam_13joback.csv'
...
#out_data.to_csv('Features_hc_noembmat_6b6gen.csv', index = False)
...
gen_out_data.to_csv('Features_gen_hc_noembmat_6b6gen.csv', index = False)
