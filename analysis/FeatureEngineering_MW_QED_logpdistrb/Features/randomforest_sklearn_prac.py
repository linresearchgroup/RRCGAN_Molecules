...
data = pd.read_csv('Features_gen_hc_noembmat_6b6gen.csv')
y = data.iloc[:,-1].values
y = y.reshape((-1,1))
y=y.astype('int')
X = data.iloc[:,:-1].values
print (X)
print ("X_shape before selections: ", X.shape)
print ("y_shape before selections: ", y.shape)
print (type(y))
X =  SelectKBest(chi2, k=2).fit_transform(X, y)

print ("X_shape after selections: ", X.shape)
