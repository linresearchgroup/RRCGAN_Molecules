...
with open('./../data/trainingsets/highcv_DFT_trans2/highcv_DFT_test.pickle', 'rb') as f:
    X_smiles_val, SMILES_val, y_val = pickle.load(f)

with open('./../data/trainingsets/60000_train_regular_qm9/tokenizer.pickle', 'rb') as f:
    tokenizer = pickle.load(f)
tokenizer[0] = ' '

with open('./../data/trainingsets/highcv_DFT_trans2/highcv_DFT.pickle', 'rb') as f:
...
encoder = load_model('./../data/nns/encoder_newencinp_trans2.h5')
decoder = load_model('./../data/nns/decoder_newencinp_trans2.h5')
...
#try:
regressor =     load_model('./../data/nns/regressor_trans2.h5')
regressor_top = load_model('./../data/nns/regressor_top_trans2.h5')
print (".h5 was read")
"""
except:
...
history = regressor.fit([train_atoms_embedding, train_bonds_embedding], 
              y_train,
...
regressor_top.save('./../data/nns/regressor_top_trans2.h5')
...
output.to_csv ('./../experiments/regular/trans2_20screen.csv', index=False)
...
output2.to_csv('./../experiments/regular/trans2_NODUP_20screen.csv', index = False)
