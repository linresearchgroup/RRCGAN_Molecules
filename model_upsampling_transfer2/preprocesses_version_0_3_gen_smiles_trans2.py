...
"""
data_gen = pd.read_csv('./Higher42_CV_DFT_HA11orless.csv')
...
with open('./../data/trainingsets/highcv_DFT_trans2/highcv_DFT.pickle', 'wb') as f:
    pickle.dump((X_gen_smiles, gen_smiles, DFT_cv),f)

with open('./../data/trainingsets/highcv_DFT_trans2/highcv_DFT_train.pickle', 'wb') as f:
    pickle.dump((X_gen_smiles_train, gen_smiles_train, DFT_cv_train),f)

with open('./../data/trainingsets/highcv_DFT_trans2/highcv_DFT_test.pickle', 'wb') as f:
