...
try:
    ...
    model = load_model  ('./../data/nns/ae_model_newencinp.h5')
...
#model.save  ('./../data/nns/ae_model_newenc.h5')
#encoder.save('./../data/nns/encoder_newenc.h5')
#decoder.save('./../data/nns/decoder_newenc.h5')
