...
encoder = load_model('./../data/nns/encoder_new.h5')
decoder = load_model('./../data/nns/decoder_new.h5')

regressor = load_model('./../data/nns/regressor_new.h5')
regressor_top = load_model('./../data/nns/regressor_top_new.h5')
print (".h5 was read")
