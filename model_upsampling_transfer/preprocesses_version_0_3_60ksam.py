...
print (len(y_train))
print (len(y_test))
with open('./../data/trainingsets_12HA/133000_train_regular_qm9/image_train.pickle', 'wb') as f:
    pickle.dump((X_smiles_train, X_atoms_train, X_bonds_train, y_train), f)
    
with open('./../data/trainingsets_12HA/133000_train_regular_qm9/image_test.pickle', 'wb') as f:
